...
/*   Updated: 2026/04/19 13:59:38 by rokuni           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	print_format(char format_type, va_list args)
{
	...
	if (format_type == 'c')
		...
		printed_chars += ft_printf_hex(va_arg(args, unsigned int), 0);
	else if (format_type == 'X')
		printed_chars += ft_printf_hex(va_arg(args, unsigned int), 1);
	else if (format_type == '%')
		printed_chars += ft_printf_char('%');
	else if (format_type == 'a')
		printed_chars += ft_printf_str("my naame is bob");
